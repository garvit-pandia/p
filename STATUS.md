...
| W8 | v2 R3, v3 R3, v4 R3 | IN PROGRESS (claimed 2026-08-09 20:56 UTC — took over stale 17:38 claim: files unmodified, git clean apart from STATUS → re-dispatch) |
...
- ~~V9 boot sequence~~ → DELIVERED W7 R2 (g9c- archive boot). ~~V10 letter snap~~ → DELIVERED W7 R2 (t10c-). ~~V1 ink-bleed + stamp press~~ → DELIVERED W7 R3 (ink-).
