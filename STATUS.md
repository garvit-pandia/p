...
| W9 | v5 R3, v6 R3, v7 R3 | IN PROGRESS (claimed 2026-08-10 08:58 UTC) |
...
- **Force-bypass localStorage pattern keeps working**: ctForce/awForce/mhForce each mirror the established wvInkForce/mfForce pattern — set key, reload, synth pointer events, assert DOM. Works for pointer-gated features of all three architectures (canvas-trail, WebGL-uniform, JS-CSS-lamp).
